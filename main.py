...
SCREEN_TEXT = {
    ...
    'game_over': {
        'title':
    """/ship_status:  [core_breached, imminent_failure]
    ./build:   a_temporal_field
loading…  success   /causality_loop(engaged) """,
...
async def show_cover_screen(screen, clock, cover_image, duration_seconds):
    ...
    duration_ms = duration_seconds * 5000
    ...
    while running:
        ...
        # if CANVAS_WIDTH == 800:
        #     screen.blit(cover_image_800, (0, 0))
        # else:
        #     screen.blit(cover_image_1200, (0, 0))
...
async def show_outro_screen(screen, clock, fonts, game_state, score, total_game_points):
    ...
    while True:
        ...
        screen.fill(COLOR_1)
        # Drawing logic... (this is your existing layout)
        title_color = COLOR_4
